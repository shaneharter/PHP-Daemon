...
class Core_Worker_ObjectMediator
{
     ...
     * @var int
     */
    private $forking_strategy = self::MIXED;
    ...
    public function __construct($alias, Core_Daemon $daemon) {
        ...
        switch(true) {
            case $interval > 2:     $this->forking_strategy = self::LAZY;       break;
            case $interval > 1:     $this->forking_strategy = self::MIXED;      break;
            default:                $this->forking_strategy = self::AGGRESSIVE; break;
        }
    }
    ...
    public function setObject($o) {
        ...
        $this->object = $o;
        $this->object->mediator = $this->mediator;
